# Rosie the robot butler
![Rosie The Robot Butler](rosie-avatar-small.jpg)

Rosie is a chat bot built on the [Hubot][hubot] framework. It was initially generated by [generator-hubot][generator-hubot], and configured to be deployed on [Heroku][heroku] to get you up and running as quick as possible.  Also, it totally has nothing to do with my friend Kyle's [Alfred Pennyworth](https://github.com/kwandrews7/slack-alfred) slack bot.
...
### Running Rosie Locally

You can test your hubot by running the following.

You can start Rosie locally by running:
...
Then you can interact with rosie by typing `rosie help`.

    rosie> rosie help

    rosie> animate me <query> - The same thing as `image me`, except adds a few
